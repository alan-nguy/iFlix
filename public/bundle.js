...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require4 = __webpack_require__(244),
	    shows = _require4.shows;

	var Landing = __webpack_require__(245);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.route.shows.filter(function (show) {
	          return (show.title + " " + show.description + " " + show.year).toUpperCase().indexOf(_this.props.searchTerm.toUpperCase()) >= 0;
	        }).map(function (show) {
	          return {/* show attribute is this.props.show in ShowCard.jsx */}, React.createElement(ShowCard, _extends({}, show, { key: show.imdbID }));
	        })
	      )
	    );
	  }
